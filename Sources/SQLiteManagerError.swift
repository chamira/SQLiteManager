...
open class SQLiteManagerError: NSError {
	...
	*/
    public static func unknownError(_ databaseName: String) -> SQLiteManagerError {
	...
	- returns: SQLiteManagerError(NSError)
	*/
    public static func databaseFileDoesNotExistInAppBundle(_ databaseName: String) -> SQLiteManagerError {
	...
	*/
    public static func kDatabaseFilePathIsNil(_ databaseName: String) -> SQLiteManagerError {
	...
	- returns: SQLiteManagerError(NSError)
	*/
    public static func bindingValuesCountMissMatch(_ databaseName: String, sqlQeuery: String, bindingParamCount: Int, valuesCount: Int ) -> SQLiteManagerError {
